...
const AllData = () => {
    ...
    const handleSearch = () => {
        ...
        fetch(apiUrl)
            ...
            .then((data) => {
                ...
                const filteredData = data.filter((curUser) => {
    ...
    const filteredTicketCount = allData.filter((curUser) => {
        if (selectedStatus && selectedStatus !== 'All' && curUser.status !== selectedStatus) {
            return false;
        }
        if (searchQueryValue) {
                ...
                {allData.length === 0 ? (
                    <div className="card-body">
                        ...
                        <div style={{ textAlign: 'center' }}>
                            ...
                            <div>
                                <br />
                                <div style={{ marginBottom: '5px' }} class="searchAndFilter">
                                    <div class="searchBar">
                                        <input class="search" type="text" name="search" value={searchValue} onChange={(e) => setSearchValue(e.target.value)}
                    ...
                    <>
                        ...
                        <div className="card-body">
                            <div>
                                ...
                                <div style={{ marginBottom: '5px' }} class="searchAndFilter">
                                    <div class="searchBar">
                                        <input class="search" type="text" name="search" onChange={(e) => setSearchValue(e.target.value)}
                                            value={searchValue}
                                            ref={searchInputRef} />
                                        <button className="srcbtn" onClick={handleSearch}><b>Search</b></button>
                                    </div>
